#!/bin/bash
#SBATCH --job-name=attn_dbg
#SBATCH --partition=compute
#SBATCH --gres=gpu:RTX3090:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=55G
#SBATCH --time=3-00:00:00
#SBATCH --output=/home/schux00/logs/vision_attention_debug_%j.out
#SBATCH --error=/home/schux00/logs/vision_attention_debug_%j.err

echo "TEKO Vision+Attention Debug"
...
enroot start --rw \
  ...
  /workspace/isaaclab/_isaac_sim/python.sh -u \
    /workspace/teko/scripts/train_vision_attention_debug.py \
