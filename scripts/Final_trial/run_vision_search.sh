#!/bin/bash
#SBATCH --job-name=vis_search
#SBATCH --partition=compute
#SBATCH --gres=gpu:RTX3090:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=55G
#SBATCH --time=4-00:00:00
#SBATCH --output=/home/schux00/logs/vision_search_%j.out
#SBATCH --error=/home/schux00/logs/vision_search_%j.err

set -euo pipefail

echo "=============================================="
echo "TEKO Vision SEARCH - Arena-Wide Docking"
echo "=============================================="
...
enroot start --rw \
  ...
  /workspace/isaaclab/_isaac_sim/python.sh -u \
    /workspace/teko/scripts/Final_trial/train_vision_search.py \
    --headless \
    --enable_cameras
