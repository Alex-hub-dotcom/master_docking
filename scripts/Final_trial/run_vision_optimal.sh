...
#SBATCH --output=/home/schux00/logs/vision_optimal_%j.out
#SBATCH --error=/home/schux00/logs/vision_optimal_%j.err

set -euo pipefail

echo "=============================================="
echo "TEKO Vision OPTIMAL - Trial 80 Hyperparameters"
echo "=============================================="
...
enroot start --rw \
  ...
  /workspace/isaaclab/_isaac_sim/python.sh -u \
    /workspace/teko/scripts/Final_trial/train_vision_optimal.py \
    --headless \
    --enable_cameras
