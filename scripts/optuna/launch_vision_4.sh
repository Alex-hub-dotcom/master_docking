...
#SBATCH --array=0-3
#SBATCH --output=/home/schux00/logs/teko_vision_%A_%a.out
#SBATCH --error=/home/schux00/logs/teko_vision_%A_%a.err
...
enroot start --rw \
    ...
    /workspace/isaaclab/_isaac_sim/python.sh -u \
        /workspace/teko/scripts/optuna/train_optuna_vision.py \
        --headless \
        --enable_cameras \
