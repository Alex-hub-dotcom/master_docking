#!/bin/bash
#SBATCH --job-name=teko_yawaux
#SBATCH --partition=compute
#SBATCH --gres=gpu:RTX3090:1
#SBATCH --cpus-per-task=12
#SBATCH --mem=55G
#SBATCH --time=7-00:00:00
#SBATCH --output=/home/schux00/logs/teko_vision_imu_yawaux_%j.out
#SBATCH --error=/home/schux00/logs/teko_vision_imu_yawaux_%j.err
...
echo "=============================================="
echo "TEKO Vision + IMU + Auxiliary Yaw Head (v10)"
echo "=============================================="
...
enroot start --rw \
  ...
  /workspace/isaaclab/_isaac_sim/python.sh -u \
    /workspace/teko/scripts/optuna/train_optuna_vision_imu_yawaux.py \
    --seed "${SEED}" \
    --headless \
    --enable_cameras
